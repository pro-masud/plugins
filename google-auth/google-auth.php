...
$gClient->setClientId("1028134609395-i5b3okn0ujotsd5hlhhdlh2e0bktsrt2.apps.googleusercontent.com");
$gClient->setClientSecret("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");
$gClient->setApplicationName("Vicode Media Login");
$gClient->setRedirectUri(admin_url('admin-ajax.php?action=vm_login_google'));
